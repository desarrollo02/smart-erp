...
/** Second physical customization proving that company results do not share overlays. */
@ApplicationScoped
public class ReferenceCustomizationBDefinition implements PluginDefinition {

    public static final PluginId ID = new PluginId("reference_custom_b");
    ...
    private static final PluginDescriptor DESCRIPTOR = new PluginDescriptor(
            ...
            List.of(new ScreenOverlay(
                    new ContributionId("reference_custom_b.dashboard"),
                    new ScreenId(REFERENCE_PLUGIN, "dashboard"),
                    VERSION_ONE,
                    List.of(
                            new ScreenChange.Label(
                                    new ScreenElementId("summary"),
                                    new ScreenTextKey("reference_custom_b.dashboard.summary")),
                            ...
                            new ScreenChange.SlotContent(
                                    ...
                                    new ScreenFragmentId(ID, "company_notice"),
                                    0)))));
