...
@Entity
@Table(name = "supplier_return_line", schema = PurchasingPersistenceNames.SCHEMA)
@IdClass(SupplierReturnLineEntity.Key.class)
public class SupplierReturnLineEntity {
    ...
    @Id @Column(name = "supplier_return_line_id", nullable = false, updatable = false)
    private UUID supplierReturnLineId;
    ...
    @Column(name = "returned_quantity", nullable = false, precision = 30, scale = 6, updatable = false)
    ...
    protected SupplierReturnLineEntity() {
    }

    static SupplierReturnLineEntity from(
            UUID companyId, UUID supplierReturnId, UUID orderId, int position,
            SupplierReturn.Line line,
            Optional<StockMovementId> movementId) {
        SupplierReturnLineEntity entity = new SupplierReturnLineEntity();
        entity.companyId = companyId;
        entity.supplierReturnId = supplierReturnId;
        entity.supplierReturnLineId = line.id().value();
        entity.position = position;
        entity.purchaseOrderId = orderId;
        entity.purchaseOrderLineId = line.orderLineId().value();
        entity.goodsReceiptId = line.receiptId().value();
        entity.goodsReceiptLineId = line.receiptLineId().value();
    ...
    SupplierReturn.Line snapshot() {
        return new SupplierReturn.Line(
                new SupplierReturnLineId(supplierReturnLineId),
                new GoodsReceiptId(goodsReceiptId), new GoodsReceiptLineId(goodsReceiptLineId),
    ...
    SupplierReturnLineId id() { return new SupplierReturnLineId(supplierReturnLineId); }
    ...
    public static final class Key implements Serializable {
        ...
        public UUID supplierReturnLineId;
        public Key() { }
        Key(UUID companyId, UUID supplierReturnId, UUID supplierReturnLineId) { this.companyId = companyId; this.supplierReturnId = supplierReturnId; this.supplierReturnLineId = supplierReturnLineId; }
        @Override public boolean equals(Object other) { return this == other || other instanceof Key that && Objects.equals(companyId, that.companyId) && Objects.equals(supplierReturnId, that.supplierReturnId) && Objects.equals(supplierReturnLineId, that.supplierReturnLineId); }
        @Override public int hashCode() { return Objects.hash(companyId, supplierReturnId, supplierReturnLineId); }
    }
}
