...
Este directorio contiene un manual independiente por cada módulo navegable del baseline de Sprint 8. Cada manual explica el vocabulario funcional, las pantallas, los datos, los permisos, los recorridos operativos y las tablas afectadas.
...
El manual `07` documenta las pantallas reales definidas por J11-S9-05. Compras
continúa fuera de la composición física hasta J11-S9-06 y sus pruebas están
diferidas; el manual no presenta el módulo como productivo.
