<article>
  <div class="page-footer">Smart ERP · Manual de Compras · edición 2026-08-13 · página <span class="page-number"></span></div>
  <header class="cover">
    ...
    <div class="meta"><strong>Versión documentada:</strong> plugin <code>purchasing</code> 1.1, historias J11-S9-07/J11-S9-08.<br><strong>Estado:</strong> congelada técnicamente con G0–G6 verdes e instalador interno creado; la validación independiente, Authenticode y la matriz Windows siguen pendientes. No es una versión comercializable ni productiva.<br><strong>Acceso local de la candidata:</strong> <code>http://localhost:18080/logixone/</code>.<br><strong>Audiencia:</strong> solicitantes, aprobadores, compradores, responsables de recepción, supervisores y soporte.<br><strong>Fuente de datos:</strong> código, contratos, migraciones V1–V2 y pruebas automatizadas del repositorio.</div>
  </header>
