<article>
  <div class="page-footer">Smart ERP · Manual de Compras · edición 2026-08-15 · página <span class="page-number"></span></div>
  <header class="cover">
    ...
    <div class="meta"><strong>Versión documentada:</strong> plugin <code>purchasing</code> 1.2, historia J11-S10-04 sobre el baseline J11-S9-07/J11-S9-08.<br><strong>Estado:</strong> implementada y validada automáticamente; la validación independiente, Authenticode y la matriz Windows siguen pendientes. No es una versión comercializable ni productiva.<br><strong>Acceso local de la candidata:</strong> <code>http://localhost:18080/logixone/</code>.<br><strong>Audiencia:</strong> solicitantes, aprobadores, compradores, responsables de recepción, supervisores y soporte.<br><strong>Fuente de datos:</strong> código, contratos 2.0, migraciones V1–V2 y pruebas automatizadas del repositorio.</div>
  </header>
  ...
  <section class="toc">
    ...
    <p>Las rutas y opciones de menú no cambiaron. Solicitudes es una bandeja de trabajo: al abrir una solicitud, la selección ocupa el área principal y muestra sus líneas, resumen y acciones válidas. Órdenes reúne cabecera, líneas, total y ciclo de vida en un editor de documento. Recepciones y Devoluciones conducen la captura en orden de contexto, datos, orientación, resumen y acciones. Seguimiento es una consulta de solo lectura. En teléfono, las tablas se presentan como tarjetas apiladas; versión, identidades internas e idempotencia permanecen ocultas.</p>
    <h3>Permisos</h3>
  ...
  <section class="screen" data-screen="purchasing-requests">
    ...
    <div class="wireframe">┌ Compras · Solicitudes · bandeja de trabajo ─────────────────────────┐
│ Filtros: número/descripción · estado                    [Buscar]    │
├ Trabajo pendiente / resultados ─────────────────────────────────────┤
│ número · fecha · estado · líneas                         [Abrir]    │
├ Solicitud seleccionada: cabecera · líneas · resumen ────────────────┤
│ [Agregar línea] [Enviar] [Aprobar/Rechazar] [Cancelar] [Clonar]    │
├ Nueva solicitud ────────────────────────────────────────────────────┤
│ número · fecha · artículo/servicio · cantidad · precio  [Preparar] │
└──────────────────────────────────────────────────────────────────────┘
En compacto, cada fila se convierte en una tarjeta vertical.</div>
  ...
  <section class="screen" data-screen="purchasing-orders">
    ...
    <h3>Bosquejo orientativo de la pantalla</h3>
    <div class="wireframe">┌ Compras · Órdenes · editor de documento ────────────────────────────┐
│ Filtros y órdenes existentes                              [Abrir]  │
├ Cabecera ───────────────────────────────────────────────────────────┤
...
│ [Preparar] [Emitir] [Cancelar] [Cerrar con faltante]               │
└──────────────────────────────────────────────────────────────────────┘</div>
    <h3>Datos y acciones</h3>
    <table><thead><tr><th>Dato o acción</th><th>Significado</th><th>Regla y resultado</th></tr></thead><tbody>
  ...
  <section class="screen" data-screen="purchasing-receipts">
    ...
    <h3>Bosquejo orientativo de la pantalla</h3>
    <div class="wireframe">┌ Compras · Recepciones · operación guiada ──────────────────────────┐
│ 1. Buscar una recepción o iniciar una nueva                        │
│ 2. Contexto: número · orden emitida · línea pendiente              │
│ 3. Captura: cantidad y, si es Stock, depósito/ubicación/trazabilidad│
│ 4. Orientación y resumen antes de afectar existencias              │
│                                      [Preparar] [Confirmar]         │
└──────────────────────────────────────────────────────────────────────┘</div>
    <h3>Datos y acciones</h3>
    <table><thead><tr><th>Dato o acción</th><th>Significado</th><th>Regla y resultado</th></tr></thead><tbody>
  ...
  <section class="screen" data-screen="purchasing-returns">
    ...
    <h3>Bosquejo orientativo de la pantalla</h3>
    <div class="wireframe">┌ Compras · Devoluciones · operación guiada ─────────────────────────┐
│ 1. Buscar una devolución o iniciar una nueva                       │
│ 2. Contexto: orden · recepción confirmada · línea recibida         │
│ 3. Captura: cantidad a devolver · causa                            │
│ 4. Orientación y resumen con la trazabilidad heredada              │
│                                      [Preparar] [Confirmar]         │
└──────────────────────────────────────────────────────────────────────┘</div>
    <h3>Datos y acciones</h3>
    <table><thead><tr><th>Dato o acción</th><th>Significado</th><th>Regla y resultado</th></tr></thead><tbody>
  ...
  <section class="screen" data-screen="purchasing-tracking">
    ...
    <h3>Bosquejo orientativo de la pantalla</h3>
    <div class="wireframe">┌ Compras · Seguimiento · consulta ──────────────────────────────────┐
