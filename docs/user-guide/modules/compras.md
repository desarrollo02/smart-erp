<article>
  <div class="page-footer">Smart ERP · Manual de Compras · edición 2026-08-20 · página <span class="page-number"></span></div>
  <header class="cover">
    ...
    <div class="meta"><strong>Versión documentada:</strong> plugin <code>purchasing</code> 1.2, historia J11-S10-04 y corrección de flujo lista/alta/detalle del 2026-08-20 sobre el baseline J11-S9-07/J11-S9-08.<br><strong>Estado:</strong> implementada y validada automáticamente; la validación independiente, Authenticode y la matriz Windows siguen pendientes. No es una versión comercializable ni productiva.<br><strong>Acceso local de la candidata:</strong> <code>http://localhost:18080/logixone/</code>.<br><strong>Audiencia:</strong> solicitantes, aprobadores, compradores, responsables de recepción, supervisores y soporte.<br><strong>Fuente de datos:</strong> código, contratos 2.0, migraciones V1–V2 y pruebas automatizadas del repositorio.</div>
  </header>
  ...
  <section class="toc">
    ...
    <dl class="term-grid">
      ...
      <dt>Versión</dt><dd>Número técnico de control de concurrencia que la pantalla administra sin pedirlo al operador. Si otra persona cambió el documento, debe recargar antes de operar.</dd>
      ...
      <dt>Idempotencia</dt><dd>Protección técnica, gestionada por el sistema, que evita duplicar una misma operación cuando el navegador o la red la reintentan.</dd>
    </dl>
    <h3>Cómo se organizan las cinco pantallas</h3>
    <p>Las rutas y opciones de menú no cambiaron. Cada opción separa tres momentos: la <strong>lista</strong> muestra filtros y resultados; <strong>Preparar…</strong> abre una pantalla de alta sin mezclar documentos existentes; y <strong>Ver</strong> abre el detalle con sus líneas, resumen y acciones válidas. <strong>Volver a la lista</strong> regresa a la bandeja sin mantener el formulario en pantalla. Seguimiento conserva el mismo patrón lista-detalle, pero es de solo lectura. En teléfono, las tablas se presentan como tarjetas apiladas; versión, identidades internas e idempotencia permanecen ocultas.</p>
    <h3>Permisos</h3>
  ...
  <section class="screen" data-screen="purchasing-requests">
    ...
    <div class="wireframe">┌ Lista de solicitudes ─────────────────────── [Preparar solicitud] ┐
│ Filtros: número/descripción · estado                    [Buscar]    │
├ Trabajo pendiente / resultados ─────────────────────────────────────┤
│ número · fecha · estado · líneas                           [Ver]    │
└──────────────────────────────────────────────────────────────────────┘
┌ Alta de solicitud ────────────────────────────── [Volver a la lista] ┐
│ cabecera · primera línea · precio/moneda              [Preparar]   │
└──────────────────────────────────────────────────────────────────────┘
┌ Detalle de solicitud ─────────────────────────── [Volver a la lista] ┐
│ cabecera · líneas · resumen · acciones válidas                      │
│ [Agregar línea] [Enviar] [Aprobar/Rechazar] [Cancelar] [Clonar]    │
└──────────────────────────────────────────────────────────────────────┘
En compacto, cada fila se convierte en una tarjeta vertical.</div>
  ...
  <section class="screen" data-screen="purchasing-orders">
    ...
    <h3>Bosquejo orientativo de la pantalla</h3>
    <div class="wireframe">┌ Lista de órdenes ───────────────────────────── [Preparar orden] ┐
│ Filtros y órdenes existentes                                [Ver]  │
└──────────────────────────────────────────────────────────────────────┘
┌ Alta o detalle de orden ───────────────────────── [Volver a la lista] ┐
├ Cabecera ───────────────────────────────────────────────────────────┤
│ número · proveedor · moneda · justificación directa                │
├ Líneas ─────────────────────────────────────────────────────────────┤
│ tipo · artículo · cantidad · precio · asignación        [Agregar]  │
│ líneas del documento                                                │
├ Resumen ───────────────────────────── total · estado · cumplimiento ┤
│ [Preparar/Agregar] [Emitir] [Cancelar] [Cerrar con faltante]       │
└──────────────────────────────────────────────────────────────────────┘</div>
    <h3>Datos y acciones</h3>
    <table><thead><tr><th>Dato o acción</th><th>Significado</th><th>Regla y resultado</th></tr></thead><tbody>
  ...
  <section class="screen" data-screen="purchasing-receipts">
    ...
    <h3>Bosquejo orientativo de la pantalla</h3>
    <div class="wireframe">┌ Lista de recepciones ───────────────────── [Preparar recepción] ┐
│ filtros · recepciones existentes                              [Ver]│
└──────────────────────────────────────────────────────────────────────┘
┌ Alta o detalle de recepción ────────────────────── [Volver a la lista] ┐
│ 1. Contexto: número · orden emitida · línea pendiente              │
│ 2. Captura: cantidad y, si es Stock, depósito/ubicación/trazabilidad│
│ 3. Orientación y resumen antes de afectar existencias              │
│                                      [Preparar] [Confirmar]         │
└──────────────────────────────────────────────────────────────────────┘</div>
    <h3>Datos y acciones</h3>
    <table><thead><tr><th>Dato o acción</th><th>Significado</th><th>Regla y resultado</th></tr></thead><tbody>
  ...
  <section class="screen" data-screen="purchasing-returns">
    ...
    <h3>Bosquejo orientativo de la pantalla</h3>
    <div class="wireframe">┌ Lista de devoluciones ───────────────── [Preparar devolución] ┐
│ filtros · devoluciones existentes                             [Ver]│
└──────────────────────────────────────────────────────────────────────┘
┌ Alta o detalle de devolución ───────────────────── [Volver a la lista] ┐
│ 1. Contexto: orden · recepción confirmada · línea recibida         │
│ 2. Captura: cantidad a devolver · causa                            │
│ 3. Orientación y resumen con la trazabilidad heredada              │
│                                      [Preparar] [Confirmar]         │
└──────────────────────────────────────────────────────────────────────┘</div>
    <h3>Datos y acciones</h3>
    <table><thead><tr><th>Dato o acción</th><th>Significado</th><th>Regla y resultado</th></tr></thead><tbody>
  ...
  <section class="screen" data-screen="purchasing-tracking">
    ...
    <h3>Bosquejo orientativo de la pantalla</h3>
    <div class="wireframe">┌ Lista de seguimiento · consulta ──────────────────────────────────┐
│ Filtros: número/proveedor · estado                     [Buscar]    │
├ Cumplimiento de órdenes ────────────────────────────────────────────┤
│ número · proveedor · estado · total                    [Consultar] │
└──────────────────────────────────────────────────────────────────────┘
┌ Orden seleccionada ─────────────────────────────── [Volver a la lista] ┐
│ por línea: pedida · recibida · devuelta · pendiente                │
└──────────────────────────────────────────────────────────────────────┘
En compacto, el cumplimiento se lee como tarjetas apiladas.</div>
    <h3>Datos</h3>
  ...
  <section>
    ...
    <ul>
      ...
      <li>Después de actualizar contexto o ejecutar una acción, el foco vuelve al primer campo inválido, al mensaje visible o al título; con movimiento reducido se eliminan transiciones no esenciales.</li>
    ...
    <p><strong>Canal de soporte:</strong> utilice el canal definido por el implementador y adjunte el identificador de correlación cuando la pantalla lo muestre. Mientras falten la validación independiente y la matriz externa de J11-S9-08, cualquier uso debe limitarse a revisión interna controlada.</p>
  </section>
</article>
